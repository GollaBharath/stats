...
async function fetchLinesOfCode(headers) {
	try {
		...
		// Note: WakaTime's free tier doesn't provide reliable "lines of code" data
		// Lines of code in summaries is a premium feature and often returns 0
		// For all-time lines of code, you would need to integrate with GitHub commits API
		return {
			last_7_days: totalLinesLast7Days,
			last_30_days: totalLinesLast30Days,
			all_time: null, // Not available from WakaTime free tier
		};
	} catch (error) {
